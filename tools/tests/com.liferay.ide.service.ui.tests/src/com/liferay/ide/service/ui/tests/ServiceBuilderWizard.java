...
public interface ServiceBuilderWizard extends UIBase
{
    ...
    public final String LABEL_SERVICE_BUILDER_TITLE = "New Liferay Service Builder";
    ...
    public final String MENU_SERVICE_BUILDER = "Liferay Service Builder";

    public final String TOOLTIP_MENU_NEW = "New";
    public final String TOOLTIP_MENU_PACKAGE = "Package";
    public final String TOOLTIP_MENU_LIFERAY_SERVICE_BUILDER = "Liferay Service Builder";
    public final String TOOLTIP_MENU_ITEM_NEW_LIFERAY_SERVICE_BUILDER = "New Liferay Service Builder";
